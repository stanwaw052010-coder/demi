...
def normalize_phone(raw: str) -> str | None:
    ...
    Принимает: «+380 (98) 104-74-54», «380981047454», «0981047454», «981047454».
...
def format_phone(normalized: str) -> str:
    """+380981047454 -> «+380 (98) 104 74 54» для показа в интерфейсе."""
...
def validate_name(raw: str) -> str | None:
    """
    Проверяет имя и возвращает очищенную версию.

    Отсекает эмодзи, ссылки, цифры и слишком длинный ввод.
    """
    if not raw:
        return None
