...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "border-border text-foreground flex h-10 w-full items-center justify-between rounded-lg border bg-white px-3 py-2 text-sm",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      className={cn(
        "border-border text-foreground relative z-50 min-w-32 overflow-hidden rounded-lg border bg-white shadow-lg",
