        ...
        {gallery.map((item, index) => (
          <li key={item.src + index} className="mb-4 break-inside-avoid">
            <motion.button
              ...
              className={cn(
                "group relative block w-full overflow-hidden focus-visible:outline-offset-4",
                spanClass[item.span],
              )}
            >
              ...
              <span
                aria-hidden
                className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-espresso/85 to-transparent p-4 pt-10 text-left opacity-0 transition-opacity duration-500 group-hover:opacity-100"
              >
                <span className="label-spaced text-gold-light">Дивитися</span>
              </span>
        ...
        {active && openIndex !== null ? (
          ...
          >
            <button
              ...
              type="button"
              onClick={close}
              className="absolute right-4 top-4 z-10 flex h-11 w-11 items-center justify-center border border-gold/35 text-gold transition-colors hover:border-gold hover:bg-gold/10 sm:right-8 sm:top-8"
            >
            ...
            <button
              ...
              className="absolute left-2 top-1/2 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center text-gold transition-transform duration-300 hover:-translate-x-1 hover:-translate-y-1/2 sm:left-6"
            >
            ...
            <button
              ...
              className="absolute right-2 top-1/2 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center text-gold transition-transform duration-300 hover:translate-x-1 hover:-translate-y-1/2 sm:right-6"
            >
            ...
            >
              ...
              <figcaption className="mt-6 text-center text-sm text-beige">
                {active.alt}
