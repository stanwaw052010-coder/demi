        ...
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          <Reveal direction="up" delay={0.16}>
            <p className="mt-6 max-w-xl text-[1.05rem] leading-relaxed text-white/65 text-pretty md:text-[1.15rem]">
              Якісний педикюр та манікюр. Усе, що вам для цього потрібно зробити, — приходити до нас у
              гості раз на місяць. За все інше потурбуємось ми. Записуйтесь у зручний для вас час.
            </p>
          </Reveal>
