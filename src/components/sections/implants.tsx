          ...
          <div className="lg:sticky lg:top-44 lg:self-start">
            ...
            <Reveal delay={0.1}>
              <p className="mt-7 max-w-[46ch] text-[17px] leading-relaxed text-graphite md:text-[18px]">
                Реальний клінічний випадок від початку й до кінця: імпланти,
                абатменти, виготовлений під прикус протез — і повернене
                жування. Такий протез не знімається пацієнтом і тримається на
                гвинтовій фіксації.
              </p>
            </Reveal>
