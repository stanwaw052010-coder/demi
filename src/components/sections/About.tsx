...
const stats = [
  ...
  { value: "2 в 1", label: "Подологія та нігтьовий сервіс" },
  { value: "0 грн", label: "Консультація подолога для нових клієнтів" },
  { value: "−20%", label: "Знижка на першу процедуру" },
];
        ...
        <div className="grid items-center gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          ...
          <div className="order-1 lg:order-2">
            <SectionHeading
              ...
              accent="робота зі стопою"
              text={
                <>
                  ProfiTime — кабінет у Вишгороді, де подологія та нігтьовий сервіс живуть під одним дахом.
                  Ми починаємо з огляду й пояснюємо, що саме відбувається зі стопою чи нігтем, звідки взялася
                  проблема і що з нею робити далі.
                </>
              }
            />
