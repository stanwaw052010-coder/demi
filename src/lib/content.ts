...
export const heroServices = [
  ...
  "Усі сучасні методи пломбування кореневих каналів",
  "Естетична художня реставрація зубів",
...
export const services: Service[] = [
  ...
  },
  {
    ...
    summary: "Усі сучасні методи · під мікроскопом",
    detail:
  ...
  {
    id: "restoration",
    title: "Естетична художня реставрація",
