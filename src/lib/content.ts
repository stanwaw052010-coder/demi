...
export const services: Service[] = [
  ...
  },
  {
    ...
    summary: "Дітям і дорослим · під мікроскопом",
    detail:
      "Лікування карієсу та його ускладнень у будь-якому віці. Сучасні методи пломбування кореневих каналів під багаторазовим збільшенням — прибираємо лише уражені тканини й зберігаємо максимум власного зуба.",
  ...
  },
  {
    ...
    summary: "Коронки, вініри, знімні протези",
    detail:
      "Керамічні та цирконієві коронки, знімне й незнімне протезування — від одного зуба до цілої щелепи, зокрема на імплантах.",
    video: "/video/implant",
  ...
  },
  {
    ...
    summary: "Видалення та імплантація",
    detail:
      "Прості й складні видалення, а також встановлення імплантатів — з плануванням, анестезією та супроводом після втручання.",
    image: "/images/implants-1.jpg",
  },
  {
    id: "whitening",
    title: "Відбілювання",
    summary: "Сучасна лампа Beyond · до 8 тонів",
    detail:
      "Кабінетне відбілювання лампою Beyond із попередньою ремінералізацією емалі. Результат, як правило, «тримається» до 1–2 років.",
