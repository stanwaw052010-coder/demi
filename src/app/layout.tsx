...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Весь спектр стоматологічних послуг: дитяча та доросла терапевтична стоматологія, пломбування каналів, художня реставрація, усі види протезування, хірургія та імплантація, ортодонтія, відбілювання лампою Beyond.",
    siteName: site.name,
    images: [
      {
        url: "/og.jpg",
