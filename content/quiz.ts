    ...
    options: [
      {
        ...
        weights: { white: 3, green: 3, yellow: 2, oolong: 1 },
        maxCaffeine: "medium",
      },
      {
        id: "medium",
        ...
        weights: { oolong: 3, red: 2, sheng: 2, yellow: 1 },
      },
      {
        id: "strong",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        weights: { red: 4, white: 2, oolong: 1, sheng: 1 },
      },
      {
        id: "earthy",
    ...
    options: [
      {
        ...
        weights: { red: 3, shou: 2, matcha: 2, sheng: 1 },
      },
      {
        id: "afternoon",
    ...
    options: [
      {
        ...
        weights: { red: 3, oolong: 2, shou: 2, white: 1 },
        preferForm: "loose",
      },
      {
        id: "some",
    ...
    options: [
      {
        ...
        weights: { red: 3, shou: 2, green: 2, white: 2 },
        preferForm: "loose",
      },
      {
        id: "ritual",
