...
Галерея — бенто на 12 плиток: 4 широкі + 8 звичайних = 16 колонок, тобто рівно
чотири ряди по чотири, з однією широкою плиткою в кожному ряду. Якщо додаєте або
прибираєте фото, тримайте суму `кількість плиток + кількість широких` кратною 4,
інакше в сітці з'являться дірки.
