...
- **Фото салону (єдине фото сайту, на Hero)** — покладіть файл `public/images/hero.jpg`, він підхопиться автоматично; доки його немає, показується стокове фото (налаштування — обʼєкт `IMAGES` у `src/lib/site.ts`)
