...
`sections/hero.tsx` — темний повноекранний блок: назва клініки постерним
...
Ієрархія тут навмисна: **назва велика, контакти дрібні**. Номер уже
набраний великим у чорній смузі над шапкою й у кнопці шапки, тож дублювати
його постерним кеглем немає сенсу — це лише відбирало увагу в назви.
...
| перший екран         | назва до 112 px на темному тлі |
...
**mobile 88 / 100 / 100 / 100** (performance · accessibility · best practices · SEO).
Мобільний бал стрибає у межах 87–93 від прогону до прогону — це шум
