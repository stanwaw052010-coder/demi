...
scripts/          generate-art.mjs — генератор тимчасових візуалів секцій
...
Фірмовий знак клініки (контур зуба з каліграфічною монограмою та іскрами)
лежить у `public/images/logo.png` — це PNG із прозорим тлом, отриманий із
наданого клінікою оригіналу. Знак використовується в навігації, футері
(там інвертується у білий через CSS), як водяний знак у CTA-секції,
у favicon (`src/app/icon.png`, `src/app/apple-icon.png`) та в OG-картинці.

Щоб замінити знак, достатньо покласти новий файл на місце
`public/images/logo.png` (бажано PNG/SVG із прозорим тлом, квадратний
кроп) і перегенерувати іконки з нього.
...
логотип `logo.png` до цього набору не належить —
