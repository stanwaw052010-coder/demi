...
Мобільний бал стрибає у межах 85–92 від прогону до прогону — це шум
середовища, а не збірки: вага сторінки тримається на 445 КБ.

Перший екран навмисне побудований навколо контактів: адреса, телефон і
кнопка запису стоять перед заголовком, а сам заголовок зменшено — він більше
не перетягує увагу. Портрет у hero має `fetchPriority="low"`: LCP тут — це
текст, а на телефоні фото лежить нижче згину, тож його попереднє
завантаження лише забирало канал.
