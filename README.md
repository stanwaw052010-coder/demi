...
- **Дві схеми JSON-LD**: `BeautySalon` (адреса, координати, телефон, команда,
  послуги, `areaServed`, посилання на профіль у Google) і `FAQPage` — остання
  дозволяє показувати питання прямо у видачі.
